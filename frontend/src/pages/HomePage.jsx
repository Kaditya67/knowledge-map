...
function HomePage() {
  ...
  }, [filter, showFavorites, fetchPages])
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-64 gap-4">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400">Loading your knowledge...</p>
      </div>
    )
  }
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <Select value={filter} onChange={(e) => setFilter(e.target.value)} options={typeOptions} className="w-40" />
      ...
      {pages.length === 0 ? (
        <div className="text-center py-16">
          ...
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-2">No pages yet</h2>
